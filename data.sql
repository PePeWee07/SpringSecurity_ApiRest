...
INSERT INTO auth.users (email, name, last_name, phone_number, address, dni, password, enabled, account_non_expired, account_non_locked, credentials_non_expired)
VALUES ('pepewee0@gmail.com', 'Pepe', 'Valdiviezo', '0983439289', 'Buenavista y Napoleon Mera', '0704713618', '$2a$10$cMY29RPYoIHMJSuwRfoD3eQxU1J5Rww4VnNOUOAEPqCBshkNfrEf6', true, true, true, true);
...
INSERT INTO auth.user_roles (user_id, role_id)
SELECT (SELECT id FROM auth.users WHERE email = 'pepewee0@gmail.com'), (SELECT id FROM auth.roles WHERE name = 'USER');
